							            ...
							            <div class="modal-dialog" role="document">
								            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLiveLabel">Cadastrar novo Setor</h5>
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                </div>
                                                <div class="modal-body">
                                                <form method="POST" action="{{ action('SectorController@storeSector')}}">
                                                     @csrf
                                                <div class="form-group">
                                                        <label for="exampleInputEmail1">Nome</label>
                                                        <input type="text" class="form-control" id="exampleInputText" placeholder="Digite o nome do setor" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus> 
                                                        @error('name')
                            ...
                            <table id="data-table-basic" class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    @foreach($sectors as $s)
                                        ...
                                        <td><a href="{{route('dropSector',['id'=>$s->id])}}" onclick="return confirm('Deseja realmente realizar essa ação?')"><i class="notika-icon notika-trash"></i></a></td>
                                      </td>
                                    </tr>
                                    ...
                                    <div id="exampleModalLive{{$s->id}}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="exampleModalLiveLabel" aria-hidden="true">
							            <div class="modal-dialog" role="document">
								            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                        {!! Form::open(['route'=>['updateSector','id'=>$s->id]]) !!} 
                                                            <div class="form-group">
                                                                    <label for="exampleInputEmail1">Nome</label>
                                                                    {!! Form::text('name',$s->name,['class'=>'form-control','required'=>'required'])!!}         
